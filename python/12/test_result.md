...
| ------------- | ------------------ | -------------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| 1           | Normal           | Follow the menu structure of the game, and entering the valid data | The program does what is says it will do | The program does what is says it will do, however it doesn't give a list to select from to remove items, like it did to select them | Add list to select from for remove item. |
...
| Test number | Test description | Data input | Expected outcome | Actual outcome | Improvements |
| ------------- | ------------------ | ------------ | ------------------ | ---------------- | -------------- |
| 4           | Erroneous        | Entering data of the wrong data type, so putting integers or floats intead of letter options | The program tells you that the option is invalid, and asks to input your choice again | Since the game treats every input as a string, it just recognises it as an invalid option, the datatype is always string (see below) | None             |
...
Game is starting...
		Actual Game Menu
            ...
            F - Return selected item to inventory
            G - Quit
Please enter your choice: True
That is not a valid choice



Please enter your choice: 69
That is not a valid choice



Please enter your choice: 420.69
That is not a valid choice
